...
A deeper concern is **model collapse** — [[summary-Shumailov_2024_ai-models-collapse-when-trained-on-recursively-generated-data|Shumailov et al. (2024)]] demonstrated that models trained on data generated by previous model generations progressively lose information about the tails of the true data distribution. As AI-generated content floods the internet, future models trained on web-scraped data will increasingly train on AI-generated text, creating a recursive loop where distribution tails are systematically trimmed across model generations. This effect exacerbates training data overlap: even models trained on different web crawls may converge toward similar distributional blind spots if both crawls contain substantial AI-generated content derived from the same upstream models. The rare events that disappear first under model collapse — unusual scenarios, edge cases, novel combinations — are precisely the ones most relevant to safety-critical applications.
